...
/*
1. Given a Binary Tree and a target key. 
2. Complete the function that prints all the ancestors of the key in the given binary tree.

Sample Input
7
1 2 3 4 5 null null 7
Sample Output
4 2 1
*/
...
public class AncestorsInBinaryTree {
	// TreeNode class for a node of a Binary Search Tree
	 	 ...
	 	 public static boolean printAncestors(TreeNode node, int x) {		 
	 		 ...
	 		 boolean b1 = printAncestors(node.left,x);
	 		 boolean b2 = printAncestors(node.right,x);
